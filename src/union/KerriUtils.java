...
public class KerriUtils {
	...
	public static void makeButtonSC() {
		new IButton(new Coord(142, 8), UI.instance.minimappanel,
	...
	public static void makeButtonOH() {
		new IButton(new Coord(162, 8), UI.instance.minimappanel, Resource.loadimg("gfx/hud/buttons/healthu"),
	...
	public static void makeButtonVR() {
		new IButton(new Coord(182, 8), UI.instance.minimappanel, Resource.loadimg("gfx/hud/buttons/radiusu"),
	...
	public static void makeButtonOP() {
		new IButton(new Coord(202, 8), UI.instance.minimappanel, Resource.loadimg("gfx/hud/buttons/humanu"),
