...
public class AutoAggro extends Thread{
	...
	Coord findCurrentTask(){
		if(m_util.m_ui.fight != null && m_util.m_ui.fight.current_attack != null) return null; // do nothing
	...
	public void sendAction(String str1, String str2){
		...
		m_util.m_ui.menugrid.wdgmsg("act", (Object[])action);
	}
	...
	/*void whatsThisHotkeyDo(){
		m_util.m_ui.menugrid.digitbar.loadDefault();
	}*/
