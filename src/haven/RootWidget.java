	...
	public boolean globtype(char key, KeyEvent ev) {
		if (!super.globtype(key, ev)) {
			...
			if (Config.profile && (key == '`')) {
				new Profwnd(ui.slenhud, ui.mainview.prof, "MV prof");
				...
				new Profwnd(ui.slenhud, ui.mainview.mask.prof, "ILM prof");
			...
			} else if ((code == KeyEvent.VK_F9) && shift) {
					KerriUtils.clearOL();
