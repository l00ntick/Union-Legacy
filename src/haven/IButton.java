...
public class IButton extends SSWidget {
	...
	boolean a = false, isHovered = false, isPushed = false;
	public boolean recthit = false;

	static {
		Widget.addtype("ibtn", new WidgetFactory() {
			public Widget create(Coord c, Widget parent, Object[] args) {
				return (new IButton(c, parent, Resource
						.loadimg((String) args[0]), Resource
						.loadimg((String) args[1])));
			}
		});
	}

	public IButton(Coord c, Widget parent, BufferedImage up,
			BufferedImage down, BufferedImage hover) {
