...
public class MinimapPanel extends Window {
    static final Coord minsz = new Coord(215, 125);
    public IButton vcl;
	public IButton pcl;
	...
	cbtn.visible = false;
	{
	    ...
	    //vcl.tooltip = "Display village claims";
	}
	{
	    ...
	    //pcl.tooltip = "Display personal claims";
	}
	
	ui.minimappanel = this;
	mm = new MiniMap(new Coord(0, 32), minsz, this, ui.mainview);
	
	/*(new CheckBox(new Coord(110, 15), this, "Toggle simplified map") {
	...
	new IButton(new Coord(65, 8), this, Resource.loadimg("gfx/hud/buttons/centeru"), Resource.loadimg("gfx/hud/buttons/centerd")) {
	    public void click() {
		mm.off = new Coord();
		UI.instance.mainview.resetcam(); //Kerrigan
	    }
	...
	new IButton(new Coord(85, 8), this, Resource.loadimg("gfx/hud/buttons/simpleu"), Resource.loadimg("gfx/hud/buttons/simpled")) {
	    public void click() {
		BufferedImage tmp = down;
		down = up;
		up = tmp;
	...
	new IButton(new Coord(105, 2), this, Resource.loadimg("gfx/hud/charsh/plusup"), Resource.loadimg("gfx/hud/charsh/plusdown")) {
	    public void click() {
	...
	new IButton(new Coord(105, 16), this, Resource.loadimg("gfx/hud/charsh/minusup"), Resource.loadimg("gfx/hud/charsh/minusdown")) {
	    public void click() {
		mm.setScale(mm.scale-1);
	    }
