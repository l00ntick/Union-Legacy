...
public class OptWnd extends Window {
	...
	{ /* GENERAL TAB */
		...
		/*(new CheckBox(new Coord(142, 85), tab, "Toggle claims on login") {
		...
		(new CheckBox(new Coord(182, 25), tab, "Auto-hearth") {
		public void changed(boolean val) {
		...
		(new CheckBox(new Coord(182, 55), tab, "Village Port") {
		public void changed(boolean val) {
		...
		(new CheckBox(new Coord(142, 85), tab, "Unknown") {
			public void changed(boolean val) {
		...
		(new CheckBox(new Coord(242, 85), tab, "Red") {
			public void changed(boolean val) {
		...
		(new CheckBox(new Coord(10, 165), tab, "Use new menugrid (restart required)") {
			public void changed(boolean val) {
				Config.new_menugrid = val;
				Config.saveOptions();
			}
		}).a = Config.new_menugrid;
	    
	    (new CheckBox(new Coord(10, 200), tab, "Use new chat (restart required)") {
		public void changed(boolean val) {
		    Config.new_chat = val;
		    Config.saveOptions();
		}
		...
		(new CheckBox(new Coord(10, 235), tab, "Add timestamp in chat") {
			public void changed(boolean val) {
		...
		(new CheckBox(new Coord(220, 165), tab, "Highlight objects by alt") {
			public void changed(boolean val) {
		...
		(new CheckBox(new Coord(220, 270), tab, "Show dowsing direcion") {
			public void changed(boolean val) {
	    ...
	    (new CheckBox(new Coord(220, 305), tab, "Compress screenshots") {
		public void changed(boolean val) {
		...
		(new CheckBox(new Coord(220, 340), tab, "Show online/offline notifier") {
			public void changed(boolean val) {
	    ...
	    (new CheckBox(new Coord(220, 375), tab, "Show day time") {
	    	public void changed(boolean val) {
		...
		(new CheckBox(new Coord(220, 410), tab, "Show Liquid Meters") {
		    public void changed(boolean val) {
		        Config.flaskMeters = val;
		        Config.saveOptions();
		    }
	    }).a = Config.flaskMeters;
		
		(new CheckBox(new Coord(220, 445), tab, "Toggle CA on login") {
			public void changed(boolean val) {
			    Config.toggleCA = val;
			    Config.saveOptions();
			}
		...
		(new CheckBox(new Coord(220, 480), tab, "Toggle tracking on login") {
			public void changed(boolean val) {
			    Config.toggleTR = val;
			    Config.saveOptions();
			}
		 ...
		 /*(new CheckBox(new Coord(220, 480), tab, "Draw higlighted herbs as icons") {
			public void changed(boolean val) {
	...
	{ /* CAMERA TAB */
	    curcam = Utils.getpref("union.defcam", "border");
	...
	{ /* AUDIO TAB */
	    ...
	    new Label(new Coord(110, 40), tab, "Music volume:");
	    new Frame(new Coord(110, 65), new Coord(20, 206), tab);
		new Label(new Coord(210, 40), tab, "Alert volume:");
	    ...
	    final Label musicvol = new Label(new Coord(135, 69 + (int)(Config.musicVol * 1.86)),  tab, String.valueOf(100 - getsfxvol()) + " %");
		final Label alertVol = new Label(new Coord(235, 69 + (int)(Config.alertVol * 1.86)),  tab, String.valueOf(100 - getsfxvol()) + " %");
		...
		(new Scrollbar(new Coord(125, 70), 196, tab, 0, 100) {{ val = 100 - Config.musicVol; }
		public void changed() {
		    //Audio.setvolume((100 - val) / 100.0);
	    ...
	    (new Scrollbar(new Coord(225, 70), 196, tab, 0, 100) {{ val = 100 - Config.alertVol; }
		public void changed() {
			//Audio.setvolume((100 - val) / 100.0);
	    ...
	    (new CheckBox(new Coord(110, 270), tab, "Music enabled") {
		public void changed(boolean val) {
	    ...
	    for (final String[] checkbox : checkboxesList) {
			CheckBox chkbox = new CheckBox(new Coord(280, y += 35), tab, checkbox[0]) {
				public void changed(boolean val) {
			...
			new Button(new Coord(355, y+15), 40, tab, "Play") {
				public void click() {
		...
		(new CheckBox(new Coord(10, 305), tab, "Memorize Sound IDs") {
		public void changed(boolean val) {
		    Config.soundMemo = val;
		}
	    }).a = Config.soundMemo;
		new Button(new Coord(10, 350), 125, tab, "Clear Sound IDs") {
		public void click() {
	...
	{ /* HIDE OBJECTS TAB */
	    ...
	    new Label(new Coord(205, 40), tab, "Red");
	    new Label(new Coord(235, 40), tab, "Green");
	    new Label(new Coord(265, 40), tab, "Blue");
	    new Label(new Coord(295, 40), tab, "Alpha");
	    new Frame(new Coord(210, 65), new Coord(20, 160), tab);
	    new Frame(new Coord(240, 65), new Coord(20, 160), tab);
	    new Frame(new Coord(270, 65), new Coord(20, 160), tab);
	    new Frame(new Coord(300, 65), new Coord(20, 160), tab);
	    (new Scrollbar(new Coord(225, 70), 150, tab, 0, 255) {{ val = max - Config.hideColor.getRed(); }
		public void changed() {
	    ...
	    (new Scrollbar(new Coord(255, 70), 150, tab, 0, 255) {{ val = max - Config.hideColor.getGreen(); }
		public void changed() {
	    ...
	    (new Scrollbar(new Coord(285, 70), 150, tab, 0, 255) {{ val = max - Config.hideColor.getBlue(); }
		public void changed() {
	    ...
	    (new Scrollbar(new Coord(315, 70), 150, tab, 0, 255) {{ val = max - Config.hideColor.getAlpha(); }
		public void changed() {
			Config.hideColor = new Color(Config.hideColor.getRed(), Config.hideColor.getGreen(),
	    ...
	    (new CheckBox(new Coord(220, 220), tab, "I am a crazy man!") {
			public void changed(boolean val) {
			    Config.aimacrazyman = val;
			}}).a = Config.aimacrazyman;
	    //scents
	    (new CheckBox(new Coord(200, 250), tab, "Hide Tresspass") {
			public void changed(boolean val) {
			    Config.hideTressp = val;
			    Config.saveOptions();
			}}).a = Config.hideTressp;
	    (new CheckBox(new Coord(200, 280), tab, "Hide Theft") {
			public void changed(boolean val) {
			    Config.hideTheft = val;
			    Config.saveOptions();
			}}).a = Config.hideTheft;
	    (new CheckBox(new Coord(200, 310), tab, "Hide Assault") {
			public void changed(boolean val) {
			    Config.hideAsslt = val;
			    Config.saveOptions();
			}}).a = Config.hideAsslt;
	    (new CheckBox(new Coord(200, 340), tab, "Hide Vandalism") {
			public void changed(boolean val) {
			    Config.hideVand = val;
			    Config.saveOptions();
			}}).a = Config.hideVand;
	    (new CheckBox(new Coord(200, 370), tab, "Hide Battery") {
			public void changed(boolean val) {
			    Config.hideBatt = val;
			    Config.saveOptions();
			}}).a = Config.hideBatt;
	    (new CheckBox(new Coord(200, 400), tab, "Hide Murder") {
			public void changed(boolean val) {
			    Config.hideMurd = val;
			    Config.saveOptions();
			}}).a = Config.hideMurd;
	    (new CheckBox(new Coord(10, 450), tab, "Show flavors (need restart)") {
			public void changed(boolean val) {
	...
	{ /* HIGHLIGHT OPTIONS TAB */
	    tab = body.new Tab(new Coord(300, 0), 30, "HL");
	    int i = 1;
	    ...
	    CheckBox chkbox = new CheckBox(new Coord(150, abcd), tab, "Don't scale minimap icons") {
		public void changed(boolean val) {
		...
		chkbox = new CheckBox(new Coord(150, (abcd+=35)), tab, "Hidden Yellow Halo") {
		public void changed(boolean val) {
		...
		chkbox = new CheckBox(new Coord(150, (abcd+=35)), tab, "Hidden Transparancy") {
		public void changed(boolean val) {
		...
		(new CheckBox(new Coord(150, (abcd+=35)), tab, "Use optimized claim higlighting") {
			public void changed(boolean val) {
				Config.newclaim = val;
				Config.saveOptions();
			}
	...
	{ /* ADDONS OPTIONS TAB */
	    tab = body.new Tab(new Coord(340, 0), 60, "Addons");
		
		int y = 35;
		
		CheckBox chkbox = new CheckBox(new Coord(10, (y)), tab, "Show Pathfinder Walking Path") {
		public void changed(boolean val){
		...
		chkbox = new CheckBox(new Coord(220, (y)), tab, "Show Pathfinder Hitboxes") {
		public void changed(boolean val){
		...
		new Label(new Coord(15, 115), tab, "Flask Key:");
		flask = new TextEntry(new Coord(14, 130), new Coord(50, 20), tab, HavenUtil.flaskText(Config.flaskNum) ){
			...
			public boolean keydown(KeyEvent e) {
				if(hasfocus){
					...
					String str = HavenUtil.flaskText(val);
					if(str != ""){
						settext(str);
		...
		chkbox = new CheckBox(new Coord(220, 70), tab, "Only auto fill flask") {
		public void changed(boolean val) {
		...
		new Label(new Coord(225, 115), tab, "Flask refill at:");
		final Label flaskScl = new Label(new Coord(237, 150),  tab, Double.toString( (double)(Config.flaskFill/10) ) );
		flaskScroll = new Scrollbar(new Coord(235, 135), 56, tab, 0, 10) {
		...
		chkbox = new CheckBox(new Coord(10, (abcd+=35)), tab, "Show digit toolbar") {
		public void changed(boolean val) {
			ui.menugrid.digitbar.visible = val;
			Config.setWindowOpt(ui.menugrid.digitbar.name, val);
		}
		};
		chkbox.a = ui.menugrid.digitbar.visible;
		
		chkbox = new CheckBox(new Coord(10, (abcd+=35)), tab, "Show F-button toolbar") {
		public void changed(boolean val) {
			ui.menugrid.functionbar.visible = val;
			Config.setWindowOpt(ui.menugrid.functionbar.name, val);
		}
		};
		chkbox.a = ui.menugrid.functionbar.visible;
		
		chkbox = new CheckBox(new Coord(10, (abcd+=35)), tab, "Show numpad toolbar") {
		public void changed(boolean val) {
			ui.menugrid.numpadbar.visible = val;
			Config.setWindowOpt(ui.menugrid.numpadbar.name, val);
		}
		};
		chkbox.a = ui.menugrid.numpadbar.visible;
		
		chkbox = new CheckBox(new Coord(10, (abcd+=35)), tab, "Show qwerty toolbar") {
		public void changed(boolean val) {
			ui.menugrid.qwertypadbar.visible = val;
			Config.setWindowOpt(ui.menugrid.qwertypadbar.name, val);
		}
		};
		chkbox.a = ui.menugrid.qwertypadbar.visible;
		
		chkbox = new CheckBox(new Coord(10, (abcd+=35)), tab, "Drop items when mining") {
		public void changed(boolean val) {
		...
		chkbox = new CheckBox(new Coord(10, (abcd+=35)), tab, "Chat box interaction") {
		public void changed(boolean val) {
		...
		chkbox = new CheckBox(new Coord(10, (abcd+=35)), tab, "Enable Space Hearthing") {
		public void changed(boolean val) {
		...
		chkbox = new CheckBox(new Coord(10, (abcd+=35)), tab, "Enable Ctrl Lift") {
		public void changed(boolean val) {
		...
		chkbox = new CheckBox(new Coord(10, (abcd+=35)), tab, "Disable land memorizing") {
		public void changed(boolean val){
		    Config.landMemo = val;
		    Config.saveOptions();
		}
		...
		chkbox = new CheckBox(new Coord(220, 200), tab, "Add overview panel") {
		public void changed(boolean val) {
		    Config.overview = val;
		    Config.saveOptions();
		...
		chkbox = new CheckBox(new Coord(245, 235), tab, "Hostile Overview Filter") {
		public void changed(boolean val) {
		...
		Widget overviewbox = new Frame(new Coord(245, 270), new Coord(140, 100), tab);
		...
		chkbox = new CheckBox(new Coord(220, (abcd+=35)), tab, "Force Drink on Target Swap") {
		public void changed(boolean val) {
		...
		chkbox = new CheckBox(new Coord(220, (abcd+=35)), tab, "Disable mouse actions in combat") {
		public void changed(boolean val){
		    Config.disableMouseActions = val;
		    Config.saveOptions();
		}
	    };
	    chkbox.a = Config.disableMouseActions;
		
		chkbox = new CheckBox(new Coord(220, (abcd+=35)), tab, "Single tap attack") { // new
			public void changed(boolean val) {
		    Config.singleAttack = val;
		    Config.saveOptions();
		}
	    };
		chkbox.a = Config.singleAttack;
		
		chkbox = new CheckBox(new Coord(220, (abcd+=35)), tab, "Highlight combat skills") {
		public void changed(boolean val) {
		    Config.highlightSkills = val;
		    Config.saveOptions();
		}
	    };
		chkbox.a = Config.highlightSkills;
	...
	curcam = camtype;
	Utils.setpref("union.defcam", curcam);
